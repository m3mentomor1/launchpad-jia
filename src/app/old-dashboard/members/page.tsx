// \src\app\old-dashboard\members\page.tsx
"use client";

import React from "react";
import Sidebar from "@/lib/PageComponent/Sidebar";
import MembersTable from "@/lib/components/DataTables/MembersTable";
  ...
  return (
    <>
      ...
      <div className="g-sidenav-show g-sidenav-pinned">
        <title>Members | Jia - WhiteCloak Technologies</title>
        <Sidebar activeLink="Members" />
