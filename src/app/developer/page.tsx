        ...
        >
          ...
          <div className="developer-section">
            <div className="developer-section-left">
              ...
              <Image
                className="white-cloak-logo"
                src="https://www.whitecloak.com/wp-content/uploads/2024/02/logo.svg"
                alt="White Cloak Logo"
                width={162}
                height={50}
              />
              <p>
                Established in 2014, White Cloak Technologies Inc. has grown to
                be a trusted pillar in software development from the heart of
                the Philippines. As a preferred innovation partner, we've
                collaborated with prominent corporations, converting challenges
                into success stories through adept technology applications.
                <br />
                <br />
                Beyond Jia, White Cloak has also developed other AI-powered
                applications, including{" "}
                <a
                  href="https://splurge.art"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Splurge Art
                </a>
                , an AI art generator, and{" "}
                <a
                  href="https://www.hellopixie.ai/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Pixie
                </a>
                , an AI chatbot builder for SMEs and enterprises.
              </p>
              <div
                style={{
                  display: "flex",
          ...
          <section id="contact-us" className="contact-us-section">
            <div className="contact-us-container">
              ...
              <p>
                Got inquiries about Jia or our company? <br />
                Shoot us an email.
              </p>
              <input
                type="email"
              ...
              />
              {messageError && (
                <p style={{ color: "red", fontSize: 12 }}>{messageError}</p>
              )}
              <button
                style={{
                  marginTop: 16,
