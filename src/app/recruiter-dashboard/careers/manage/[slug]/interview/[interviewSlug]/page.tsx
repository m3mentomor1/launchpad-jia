// \src\app\recruiter-dashboard\careers\manage\[slug]\interview\[interviewSlug]\page.tsx
"use client";
          ...
          <div className="col">
            {loadingRecording ? (
              <div className="card" style={{ marginBottom: "16px" }}>
                <div className="card-body">
                  <CardTypingLoader
                    ...
                    notesArray={["Loading Recording...", 400]}
                  />
                </div>
              </div>
              ...
              <div className="card" style={{ marginBottom: "16px" }}>
                <div className="card-header">
                  <h3 className="mb-0 mr-auto">
                    ...
                    {interview.interviewRecording.filetype.includes("audio")
                      ? "Audio Recording"
                      : "Video Recording"}
                  </h3>
                </div>
              ...
              <div className="card" style={{ marginBottom: "16px" }}>
                ...
                <div className="card-body">
                  <span>
                    <i className="la la-microphone-slash" /> No Recording
                    Available
                  </span>
                </div>
              </div>
        ...
        <div className="row">
          <div className="col">
            <div className="card" style={{ marginBottom: "16px" }}>
              <div className="card-header">
                <h3 className="mb-0 mr-auto">
                  <i className="la la-file-text text-primary mr-2" /> Transcript
                </h3>
              ...
              <div className="card-body">
                <div className="live-transcript">
                  ...
                  {transcripts && transcripts.length === 0 && (
                    <>
                      <i className="la la-list text-muted" /> No Transcript
                      Available.
                    </>
                  )}
                        ...
                        return (
                          <React.Fragment key={idx}>
                            ...
                            <div className="tr-time mt--2 mb-3 fade-in-bottom">
                              ...
                              <small
                                title={"Amout of time from the last message"}
                              >
                                <i className="la la-square text-primary" />{" "}
                                <i className="la la-clock" />{" "}
                                {idx > 0
