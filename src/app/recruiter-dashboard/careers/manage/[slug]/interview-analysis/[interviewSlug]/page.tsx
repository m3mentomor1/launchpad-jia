// \src\app\recruiter-dashboard\careers\manage\[slug]\interview-analysis\[interviewSlug]\page.tsx
"use client";
    ...
    const fetchInterview = async () => {
      try {
        ...
        if (!isLoadingSettingsRef.current) {
          ...
          const configData = await axios.post("/api/fetch-global-settings", {
    ...
    <>
      ...
      <div style={{ padding: "16px 20px" }}>
            ...
            >
              ...
              >
                ...
                <i
                  ...
                  style={{ fontSize: 16, color: "#6172F3", marginLeft: 4 }}
                ></i>
              </div>
            </div>
          )}
        ...
        {interview?.retakeRequest &&
          ...
          ) && <RetakeInterviewRequestV2 interviewDetails={interview} />}
        <div
          style={{
            display: "flex",
            flexDirection: "row",
                          ...
                          <React.Fragment key={idx}>
                            ...
                            >
                              <strong>
                                {msg.type === "user"
                                  ? `${
                                      interview ? interview.name : "Applicant"
                                    }`
                                  : "Jia"}
                              </strong>{" "}
                              <small>
                              ...
                              ></div>
                              <small
                                title={"Amount of time from the last message"}
                              >
                                {idx > 0
                                  ? (() => {
              ...
              <div className="layered-card-middle">
                ...
                <div className="layered-card-content">
                  ...
                  >
                    ...
                    >
                      {interview?.image && (
                        <AvatarImage src={interview.image} alt="Candidate" />
                      )}
                      <div
                        style={{
                          display: "flex",
            ...
            <div className="layered-card-outer">
              <div className="layered-card-middle">
                ...
                <div className="layered-card-content">
                  ...
                  >
                    Trigger the button below to delete the interview transcript
                    and set the status to "For Interview".
                  </span>
                  <button
                    onClick={() => {
                      // resetInterviewData();
