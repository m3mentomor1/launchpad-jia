// \src\lib\components\AdminComponents\AdminDashboard.tsx
"use client";
...
export default function AdminDashboard() {
  ...
  const [newApplicantsFilter, setNewApplicantsFilter] =
    useState("last_3_months");
  ...
  const [topOrganizationsFilter, setTopOrganizationsFilter] =
    ...
    <div className="recruiter-dashboard-container">
      <div className="recruiter-dashboard-metrics-container">
        <div
          ...
          style={{ backgroundColor: "#EFF8FF", minWidth: "360px" }}
        >
          <div className="metric-content">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              ...
              <span style={{ fontSize: 24, color: "#030217", fontWeight: 700 }}>
                {adminStats.activeOrganizations}
              </span>
            </div>
          </div>
        </div>
        <div
          className="recruiter-dashboard-metric-card"
          style={{ backgroundColor: "#FDF2FA", minWidth: "360px" }}
        >
          <div className="metric-content">
            <div className="metric-icon">
              <i
        ...
        <div
          className="recruiter-dashboard-metric-card"
          style={{ backgroundColor: "#F4F3FF", minWidth: "360px" }}
        >
          <div className="metric-content">
            <div className="metric-icon">
              <i
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
              ...
              >
                <span
                  style={{ fontSize: 14, color: "#414651", fontWeight: 500 }}
                >
                  New Applicants
                </span>
                <MetricsFilter
                  filter={newApplicantsFilter}
                  setFilter={setNewApplicantsFilter}
                />
              </div>
              <span style={{ fontSize: 24, color: "#030217", fontWeight: 700 }}>
      ...
      <div className="pending-recruiter-tasks-container">
        <div className="layered-card-content">
          ...
          >
            ...
            >
              <h1 style={{ fontSize: 20, color: "#181D27", fontWeight: 700 }}>
                Top Careers
              </h1>
              <MetricsFilter
                filter={topCareersFilter}
                setFilter={setTopCareersFilter}
              />
            </div>
            {/* <button 
            ...
            {topCareersLoading ? (
              ...
              topCareers.map((career: any, index: number) => (
                <div
                  ...
                  className="pending-recruiter-task-row"
                  style={{
                    borderBottom: index === 4 ? "none" : "1px solid #E0E0E0",
                  }}
                >
                  <div
              ...
              >
                ...
                >
                  <div
                    style={{ fontSize: 14, color: "#181D27", fontWeight: 500 }}
                  >
                    No top careers found
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="layered-card-content">
          ...
          >
            ...
            >
              ...
              <MetricsFilter
                filter={topOrganizationsFilter}
                setFilter={setTopOrganizationsFilter}
              />
            </div>
            {/* <button 
                        style={{ fontSize: 14, fontWeight: 500, borderRadius: "60px", backgroundColor: "#FFFFFF", padding: "5px 10px", border: "1px solid #D5D7DA", cursor: "pointer" }}
          ...
          <div className="pending-recruiter-task-table">
            {topOrganizationsLoading ? (
              ...
              topOrganizations.map((organization: any, index: number) => (
                <div
                  key={index}
                  className="pending-recruiter-task-row"
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div style={{ fontWeight: 500, fontSize: 14 }}>
                        {organization?.newApplications || 0}
                      </div>
                      <div style={{ fontSize: 12, color: "#787486" }}>
                        New Applications
                      </div>
...
const MetricsFilter = ({
  ...
  const filterOptions = ["last_7_days", "last_30_days", "last_3_months"];
  ...
  return (
    ...
    >
      <span
        style={{ fontSize: 12, color: "#787486", textTransform: "capitalize" }}
      >
        {filter?.replaceAll("_", " ")}
      </span>
