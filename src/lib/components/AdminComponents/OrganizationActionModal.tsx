// \src\lib\components\AdminComponents\OrganizationActionModal.tsx
export default function OrganizationActionModal({
  ...
  const actions = {
    save: {
      ...
      subtext:
        "Are you ready to publish this Organization? <br /> Once published, organization members will be able to log in and start using Jia.",
